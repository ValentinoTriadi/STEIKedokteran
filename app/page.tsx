...
export default function Home() {
  ...
  return (
    <div className="min-h-[90%] flex flex-col justify-end px-8">
      ...
      {/* For Prompt Input */}
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full border-2 border-black/5 rounded-xl p-2">
          <div className="w-full flex items-center gap-x-2"> 
            ...
            >
              <p className="hidden group-hover:block transition duration-200 ease-in-out">Send</p>
              <SendHorizontal />
            </Button>
          </div>
        </form>
